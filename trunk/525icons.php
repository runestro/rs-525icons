...
function rs_icons_function($atts){
   ...
   $return_string = '<i style="border:'.$iborder.'px solid '.$ibordercol.';border-radius:'.$iradius.'px;vertical-align:'.$ivalign.'%;color:'.$icolor.';background:'.$ibg.';padding:'.$ipadding.'px;margin:'.$imargin.'px;font-size:'.$isize.'" class="ux ico-'.$iname.'">';
   $return_string .= '</i>';
